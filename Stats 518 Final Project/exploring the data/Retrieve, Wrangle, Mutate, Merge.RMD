...
*The Script Below:* 
1) Retrieves the most up to date covid death totals for the state of Michigan by county
2) Calculates county covid deaths per 1000
3) Pulls the most recent ACS demographic estimates (2019 is the most current release as of today)
4) Calculates, county rate of unemployment, public assistance usage, racial composition, etc
5) Merges the [JHU CSSE COVID-19](https://github.com/CSSEGISandData/COVID-19.) morbidity data with the [American Community Survey (ACS)](https://www.census.gov/data/developers/data-sets/acs-5year.html) estimates into a CSV file for export

[Here](https://github.com/BrookemWalters/BrookemWalters-Portfolio/blob/main/Stats%20518%20Final%20Project/Introduction.md) explains the inspiration and the bias I bring to my data analysis. 


### Step 0 : connect the census via *API* [(full explanation here)][https://www.census.gov/programs-surveys/acs/data/data-via-api.html]
...
### Step 1.5: 
 - create a covid death rate per thousand, around round to the nearest hundredths place
...
- Set two racial population estiamtes
