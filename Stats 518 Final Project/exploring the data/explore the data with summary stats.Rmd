...
#install.packages(c("pysch", "tidyverse"))
...
write.csv(sum_table_covid_census,"~/STA 518/BrookemWalters-Portfolio/Stats 518 Final Project/data/covid_census_summary_stats.csv")
```
...
write.csv(table_covid_census,"~/STA 518/BrookemWalters-Portfolio/Stats 518 Final Project/data/Covid_Census_Table.csv")
```
